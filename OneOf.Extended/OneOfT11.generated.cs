...
namespace OneOf
{
    public readonly struct OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IOneOf
    {
        ...
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                2 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT2(o.AsT2),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                2 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT2(o.AsT2),
                3 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT3(o.AsT3),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                2 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT2(o.AsT2),
                3 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT3(o.AsT3),
                4 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT4(o.AsT4),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4, T5> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                ...
                3 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT3(o.AsT3),
                4 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT4(o.AsT4),
                5 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT5(o.AsT5),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4, T5, T6> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                ...
                4 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT4(o.AsT4),
                5 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT5(o.AsT5),
                6 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT6(o.AsT6),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4, T5, T6, T7> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                ...
                5 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT5(o.AsT5),
                6 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT6(o.AsT6),
                7 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT7(o.AsT7),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                ...
                6 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT6(o.AsT6),
                7 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT7(o.AsT7),
                8 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT8(o.AsT8),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                ...
                7 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT7(o.AsT7),
                8 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT8(o.AsT8),
                9 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT9(o.AsT9),
                _ => throw new InvalidOperationException()
            };
        
        public static implicit operator OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> o) => 
            o.Index switch
            {
                0 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT0(o.AsT0),
                1 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT1(o.AsT1),
                ...
                8 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT8(o.AsT8),
                9 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT9(o.AsT9),
                10 => OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.FromT10(o.AsT10),
                _ => throw new InvalidOperationException()
            };
